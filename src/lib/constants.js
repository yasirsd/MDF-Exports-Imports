...
export const products = [
  ...
  },
  {
    ...
    featured: true,
    landingHref: "/products/black-pepper",
    landingLabel: "Learn more. Black pepper export",
    featuredLandingLabel: "Black pepper export guide",
    blurb: "Malabar & Tellicherry grades, garbled and export-ready.",
    copy: "Sun-dried Malabar and Tellicherry black pepper from South India. Garbled MG1 / TGSEB tiers with density, volatile oil and piperine documented per lot. Built for spice programmes, grinders and processors.",
    varieties: ["MG1", "MG2", "TGSEB", "TGEB"],
    season: "Harvest Nov – Feb · Year-round from stocks",
    pack: "Jute bag with liner · 25kg / 50kg",
    coldChain: "Dry ambient · moisture-controlled store",
    markets: ["UAE", "KSA", "Qatar", "Oman", "Kuwait"],
    highlights: ["Malabar & Tellicherry", "Density graded", "Spice Board aligned"],
  },
  {
    id: "mangoes",
