/** Shared constants for the Guntur Red Chilli product landing (no React). */

export const GUNTUR_CHILLI_PATH = "/products/guntur-red-chilli";
...
export const gunturFaqs = [
  {
    q: "What is the Scoville / heat level of Guntur chilli?",
    a: "Heat varies by variety, season and lot. We do not publish a single Scoville figure for all Guntur chilli. Share the heat range your buyers expect and we will match available lots or tell you clearly if we cannot.",
  },
  {
